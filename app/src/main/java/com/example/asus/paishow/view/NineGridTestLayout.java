package com.example.asus.paishow.view;
...
import com.example.asus.paishow.utils.ImageLoaderUtil;
...
public class NineGridTestLayout extends NineGridLayout {
    ...
    protected void onClickImage(int i, String url, List<String> urlList) {
       ...
       /* Intent intent=new Intent(mContext,ShowImageActivity.class);
        intent.putCharSequenceArrayListExtra(ShowImageActivity.EXTRA_IMAGE_URLS,(ArrayList)urlList);*/
